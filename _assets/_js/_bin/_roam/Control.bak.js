	...
	// FAULT ONLY Y REGISTERED FOR MAP ENTRY
	// added css_x var
	...
	function playerEnterMap()
	{
		...
		if(PORTAL_LEVEL_TRAVEL)
		{
			...
			$("#CONTROL_CHECK").text("playerEnterMap(); IF");
		}
		...
		else
		{
			...
			$("#CONTROL_CHECK").text("playerEnterMap(); ELSE");
		}
...
*/
	...
	{
		if(MAP_PLAYER.updateListen && !PORTAL_LEVEL_TRAVEL) //levelWarping
		{
	...
	{
		$("#CONTROL_CHECK").text("controlEnd_axis(); MAP_PLAYER.enter == " + MAP_PLAYER.enter);
